...
//       </button>
//       <button onClick={() => dispatch(addAssignment({ ...assignment, course: courseId }))} className="assignment-btn float-end btn btn-danger">
...
//             <div className="list-group">
//                 {
//                 assignments.filter((module) => module.course === courseId).map((assignment, index) => (
...
//                                 margin: "10px"}}
//               onClick={() => {if(window.confirm('Are you sure to delete this record?')){ dispatch(deleteAssignment(assignment._id))}}}>
